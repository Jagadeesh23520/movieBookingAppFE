...
function Home(){
    ...
    const fetchMovies = async() => {
        try{
            const response = await axios.get('http://34.67.3.109:8085/api/v1.0/moviebooking/all', {
    ...
    const updateTicketStatus = (movieName,noOfTicketsAvailable,ticketStatus) => {
        ...
        if(noOfTicketsAvailable.toString() === '0'){
            axios.put(`http://34.67.3.109:8085/api/v1.0/moviebooking/${movieName}/update`,{},{
                headers:{
                    'Content-Type': 'application/json',
                    Authorization:`Bearer ${localStorage.getItem('accessToken')}`
                }
    ...
    const deleteMovie = (movieName) => {
        ...
        axios.delete(`http://34.67.3.109:8085/api/v1.0/moviebooking/${movieName}/delete`,{
            headers:{
                'Content-Type': 'application/json',
                Authorization:`Bearer ${localStorage.getItem('accessToken')}`
            }
